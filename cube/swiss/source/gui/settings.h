...
#define PAGE_INTERFACE_MAX (SET_PAGE_2_CANCEL)
...
#define PAGE_NETWORK_MAX (SET_PAGE_3_CANCEL)
...
#define PAGE_GAME_GLOBAL_MAX (SET_PAGE_4_CANCEL)
...
#define PAGE_GAME_DEFAULTS_MAX (SET_PAGE_5_CANCEL)
